...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="keterangan" name="keterangan" value="<?=@$vketerangan?>">
</div>
<div class="form-group">
    <label for="no_purchase_order">No Purchase Order / Memo</label>
    <input type="text" class="form-control" id="no_purchase_order" name="no_purchase_order" value="<?=@$vno_purchase_order?>" readonly>
</div>
<div class="form-group">
    <label for="no_purchase_order">No Purchase Request / Memo</label>
    <input type="text" class="form-control" id="no_purchase_request" name="no_purchase_request" value="<?=@$vno_purchase_request?>" readonly>
</div>
<div class="form-group">
    <label for="nama_vendor">Nama Vendor  </label>
    <input type="text" class="form-control" id="nama_vendor" name="nama_vendor" value="<?=@$vnama_vendor?>"readonly>
</div>
<div class="form-group">
    <label for="keterangan_pembelian">Keterangan Pembelian  </label>
    <input type="text" class="form-control" id="keterangan_pembelian" name="keterangan_pembelian" value="<?=@$vketerangan_pembelian?>"readonly>
</div>
<div class="form-group">
    <label for="tanggal_invoice">Tanggal Invoice</label>
    <input type="date" class="form-control" id="tanggal_invoice" name="tanggal_invoice" value="<?=@$vtanggal_invoice?>"readonly>
</div>
<div class="form-group">
    <label for="tanggal_dikirim">Tanggal Dikirim</label>
    <input type="date" class="form-control" id="tanggal_dikirim" name="tanggal_dikirim" value="<?=@$vtanggal_dikirim?>"readonly>
</div>
<div class="form-group"readonly>
    <label for="id_departemen"> Tujuan</label>
    <select class="form-control" name="id_departemen"readonly>
...
<div class="form-group"readonly>
    ...
    <select class="form-control" name="id_pengirim_surat"readonly>
